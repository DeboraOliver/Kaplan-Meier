...
group_same_clean <- group_same %>% select(cadast_same, cadast_idade_anos, cadast_data_programa, recent_date, icc_term_follow_up_mot, censored)
...
###Age Distribution
hist(group_same_clean$cadast_idade_anos, main = "Congestive Heart Failure: Age Frequency", xlab = "Age", border = "blue")
